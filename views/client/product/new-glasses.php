<div class="slider-for">
    <?php foreach ($glasses as $item) : ?>
        <div class="item">
            <div class="row">
                <div class="img-product col-md-6"><img src="img/upload/<?= $item['image'] ?>" alt="" height="200"></div>
                <div class="content-product col-md-6">
                    ...
                    <div class="hidden-desc"><strong>Description:</strong> <?= $item['description'] ?></div>
                </div>
            </div>
        </div>
    <?php endforeach; ?>
